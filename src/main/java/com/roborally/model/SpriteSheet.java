...
public class SpriteSheet {
  ...
  private void setFrameMap() {
    ...
    frameMap.put("green conveyor belt right connection", new Pair<>(2, 5));
    frameMap.put("green conveyor belt left connection", new Pair<>(1, 5));
    frameMap.put("green conveyor belt left and bottom connection", new Pair<>(0, 7));
    frameMap.put("green conveyor belt right and bottom connection", new Pair<>(0, 8));
    frameMap.put("green conveyor belt left and right connection", new Pair<>(4, 8));
    ...
    frameMap.put("blue conveyor belt right connection", new Pair<>(2, 3));
    frameMap.put("blue conveyor belt left connection", new Pair<>(1, 3));
    frameMap.put("blue conveyor belt left and bottom connection", new Pair<>(0, 9));
    frameMap.put("blue conveyor belt right and bottom connection", new Pair<>(4, 9));
    frameMap.put("blue conveyor belt left and right connection", new Pair<>(3, 10));
