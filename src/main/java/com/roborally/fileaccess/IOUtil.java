...
public class IOUtil {
  ...
  /**
   * Reads a string from some InputStream. The solution is based on google's Guava and a solution
   * from Baeldung: https://www.baeldung.com/convert-input-stream-to-string#guava
   *
  ...
  /**
   * Returns a string from a resource of the project. This method is implemented in such a way that
   * resource can be read when the project is deployed in a jar file.
   *
